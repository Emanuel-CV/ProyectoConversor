...
public class Monedas {
	...
	public void PesoToUsd() {
		this.valor = Double.parseDouble(JOptionPane
			...
			JOptionPane.showMessageDialog(null, "Tienes: $" + this.resultado + " USD");
	}
	...
	public void UsdToPeso() {
		this.valor = Double.parseDouble(JOptionPane
			...
			JOptionPane.showMessageDialog(null, "Tienes: $" + this.resultado + " COP");
	}
	...
	public void PesoToEur() {
		this.valor = Double.parseDouble(JOptionPane
			...
			JOptionPane.showMessageDialog(null, "Tienes: €" + this.resultado + " EUR");
	}
	...
	public void PesoToGbp() {
		this.valor = Double.parseDouble(JOptionPane
			...
			JOptionPane.showMessageDialog(null, "Tienes: £" + this.resultado + " GBP");
	}
	...
	public void PesoToJpy() {
		this.valor = Double.parseDouble(JOptionPane
			...
			JOptionPane.showMessageDialog(null, "Tienes: ¥" + this.resultado + " JPY");
	}
	...
	public void PesoToKrw() {
		this.valor = Double.parseDouble(JOptionPane
			...
			JOptionPane.showMessageDialog(null, "Tienes: ₩" + this.resultado + " KRW");
	}
